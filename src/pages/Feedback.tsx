...
export default function Feedback() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!message.trim()) {
      setError('Please write your suggestion or feedback.');
      return;
    }
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-lg mx-auto">
            Your feedback helps us improve. Rate your experience and share your suggestions — we read every submission.
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all text-gray-900 bg-white"
              >
                {toolOptions.map((t) => (
            ...
            {/* Name & Email (optional, pre-filled if logged in) */}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  placeholder="Tell us what you think, what we can improve, or what new tools you'd like to see..."
                  rows={5}
                  className="w-full pl-12 pr-4 py-3 rounded-xl border border-gray-300 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 outline-none transition-all text-gray-900 resize-none"
                />
              </div>
            </div>
